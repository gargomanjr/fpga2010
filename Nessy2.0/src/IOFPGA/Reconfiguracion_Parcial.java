            ...
            try {
                ...
                while (frame < numFrames && ejecutandoReconfiguracion) {
                    ...
                    while (bit < numBits && ejecutandoReconfiguracion) {
                        ...
                        String coms = "cmd.exe /K java -jar Virtex_II_Partial_Reconfiguration.jar -i " + fichero + " -o " + Ruta + "\\circuito_fpga_modif -f " + frame + " -b " + bit;
                        ...
                        String err = ber.readLine();
                        Thread t1 = new Thread();

                        while (std!= null && err!= null){
                        std = br.readLine();
                        err = ber.readLine();
